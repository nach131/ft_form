...
from core.models import (Form, SentForm, TextQuestion, BooleanQuestion,
                        OptionQuestion, EmailQuestion, ScaleQuestion,
...
class ScaleQuestionSerializer(ModelSerializer):
	class Meta:
		model = ScaleQuestion
		fields = ['order', 'type', 'text', 'min_value', 'max_value', 'is_required']
...
#     email_questions = serializers.SerializerMethodField()

#     class Meta:
#         model = SentForm
#         fields = ['id', 'form_id', 'form_name', 'mesage_end_form', 'user_id', 'created', 'sended', 'text_questions', 'boolean_questions', 'option_questions', 'email_questions']
...
#     def get_email_questions(self, obj):
#         questions = EmailQuestion.objects.filter(form_id = obj.form_id)
#         return EmailQuestionSerializer(questions, many = True).data
